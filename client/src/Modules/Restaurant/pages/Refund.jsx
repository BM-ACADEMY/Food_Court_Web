...
export default function Refund() {
  ...
  useEffect(() => {
    if (!loading && !user) {
      setResultMessage("Please log in to proceed with refunds.");
      setIsSuccess(false);
  ...
  const handleRefund = async () => {
    ...
    if (isNaN(refundAmount) || refundAmount <= 0 || !Number.isFinite(refundAmount)) {
          ...
          <Card className="h-full">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                >
                  {isLoading ? "Processing..." : "Refund Amount"}
                </Button>
              </div>
            </CardContent>
          </Card>
