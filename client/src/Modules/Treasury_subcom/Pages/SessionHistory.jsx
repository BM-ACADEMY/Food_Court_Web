...
const SessionHistory = () => {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 relative">
      <BackButton />
      <Card className="max-w-6xl mx-auto border-l-4 border-l-gray-800 border-r-4 border-r-gray-200 shadow-lg">
        <CardHeader className="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#000052]/10 rounded-lg text-[#000052]">
              <Clock className="h-6 w-6" />
            </div>
            <div>
              <CardTitle className="text-xl font-bold text-[#000052]">My Session History</CardTitle>
              <p className="text-xs text-gray-500 mt-1">Track your sessions, timeline actions and transactions</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-4 sm:p-6">
          ...
          <div className="flex gap-4 mb-6 flex-wrap items-end">
            <div className="w-40 flex-1 min-w-[150px]">
              <label htmlFor="startDate" className="block text-xs font-semibold text-gray-600 mb-1">
                Start Date
              </label>
              <Input
                id="startDate"
            ...
            <div className="w-40 flex-1 min-w-[150px]">
              <label htmlFor="endDate" className="block text-xs font-semibold text-gray-600 mb-1">
                End Date
              </label>
              <Input
                id="endDate"
            ...
            <Button
              ...
              disabled={loading}
              className="bg-[#00004d] hover:bg-[#000066] h-10 text-xs sm:text-sm px-6"
            >
            ...
            <Button
              ...
              disabled={loading}
              className="h-10 text-xs sm:text-sm px-6"
            >
              Clear
            </Button>
          </div>
                  ...
                  >
                    <AccordionTrigger className="hover:bg-gray-50 px-4 py-3 [&>svg]:hidden">
                      <div className="flex items-center gap-3 w-full">
                        ...
                        <div className="ml-auto flex items-center gap-3">
                          ...
                          <span className="text-xs text-gray-450">{totalSessions} session{totalSessions !== 1 ? "s" : ""}</span>
                    ...
                    <AccordionContent className="px-4 pb-4 pt-0">
                      {userSession.sessions?.length > 0 ? (
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-sm transition-shadow">
                                              <div>
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">
                                                  ...
                                                  <span className={action.status === "Completed" || action.status === "Success" ? "text-emerald-600 font-medium" : "text-gray-505"}>
                                                    {action.status}
                                                  </span>
                        ...
                        <p className="text-sm text-gray-405 italic mt-2">No sessions found for selected date range.</p>
                      )}
                    </AccordionContent>
                  </AccordionItem>
                );
